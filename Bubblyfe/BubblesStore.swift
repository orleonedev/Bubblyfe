...
class BubblesStore :ObservableObject {
    ...
    var family = Bubble(category: "Family", cardColor: Color.init(red: 194/255, green: 242/255, blue: 255/255, opacity: 100), iconColor: .blue , icon: "heart.circle.fill", bubblePoints: 0, isActive: false)
